...
import com.ats.sap_recruitment.utils.PrefManager;
...
public class IntroActivity extends AppCompatActivity {
    ...
    private int[] layouts;
    private Button btnSkip, btnNext, btnJoinNow;
...
//        }
        ...
        btnJoinNow.setTypeface(myTypefaceBold);
        tvSignUp.setTypeface(myTypefaceBold);
        ...
        btnJoinNow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(IntroActivity.this, RegisterationActivity.class));
                finish();
            }
        });
